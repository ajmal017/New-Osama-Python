...
df = pd.read_excel('D:\Stock Market\Supertrandtest.xlsx', sheet_name='Sheet1')
print(pd.read_excel('D:\Stock Market\Supertrandtest.xlsx', sheet_name='Sheet1'))


def SuperTrend(df, period, multiplier, ohlc=['Date', 'Open', 'High', 'Low', 'Close']):
    """
